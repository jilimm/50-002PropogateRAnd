...
module mojo_top_0 (
  ...
  wire [1-1:0] M_slowclk26_value;
  counter_10 slowclk26 (
    .clk(clk),
    .rst(rst),
    .value(M_slowclk26_value)
  );
  ...
  always @* begin
    ...
    if (M_mypropogater_rowLit == 2'h0) begin
      ...
      if (M_clk_gen_num[0+2-:3] == 3'h7) begin
        M_clkreg_data = 3'h4;
      end
